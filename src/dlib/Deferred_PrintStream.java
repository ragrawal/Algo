...
public class Deferred_PrintStream extends PrintWriter
{	ConsoleWindow win=null;
	PrintWriter out = null;
	String name = "Java Output";
	
/** returns true if the console window has been activated and is visible */
	public boolean Active() { return((win!=null) && win.Active()); }
...
/** create a new PrintWriter, which will create a ConsoleWindow if any
	output is performed. */
	public Deferred_PrintStream() { super(System.out); }

/** create a named new PrintStream, which will create a ConsoleWindow if any
	output is performed. */
	public Deferred_PrintStream(String name) {this(); this.name = name; }
...
/** create the output stream we will use, which is a ConsoleWindow */
	...
	{if (out==null || (win==null) || !(win.Active()))
        ...
        // Methods
    public boolean checkError() { if(out!=null) {return(out.checkError());} else { return(false);} }
    public void close() { if(out!=null) { out.close(); }}
    public void flush() { CreateStream(); out.flush(); }
    public void print(boolean  b) { CreateStream(); out.print(b); }
    public void print(char  c) { CreateStream(); out.print(c); }
    public void print(char  s[]) { CreateStream(); out.print(s); }
    public void print(double  d) { CreateStream(); out.print(d); }
    public void print(float  f) { CreateStream(); out.print(f);	}
    public void print(int  i) { CreateStream(); out.print(i);}
    public void print(long  l) { CreateStream(); out.print(l);}
    public void print(Object  obj) { CreateStream(); out.print(obj);}
    public void print(String  s) { CreateStream(); out.print(s);}

    public void println(boolean  b) { CreateStream(); out.println(b); }
    public void println(char  c) { CreateStream(); out.println(c); }
    public void println(char  s[]) { CreateStream(); out.println(s); }
    public void println(double  d) { CreateStream(); out.println(d); }
    public void println(float  f) { CreateStream(); out.println(f);	}
    public void println(int  i) { CreateStream(); out.println(i);}
    public void println(long  l) { CreateStream(); out.println(l);}
    public void println(Object  obj) { CreateStream(); out.println(obj);}
    public void println(String  s) { CreateStream(); out.println(s);}

    
	public void write(String  b, int  off, int  len)
		 { CreateStream(); out.write(b,off,len); }
	public void write(String b) { CreateStream(); out.write(b); }
	public void write(char b[],int off,int len) { CreateStream(); out.write(b,off,len); }
	public void write(int i) { CreateStream(); out.write(i); }
  public void write(char  b[])
		 { CreateStream(); out.write(b); }
	public static void main(String arg[])
	{
	Deferred_PrintStream p = new Deferred_PrintStream("test printstream");
	if(arg.length>0) 
		{for(int i=0;i<arg.length;i++) { p.println("this is a test " + arg[i]); }
		}
	p.Always_Wait_For_Finish();
	}
}
